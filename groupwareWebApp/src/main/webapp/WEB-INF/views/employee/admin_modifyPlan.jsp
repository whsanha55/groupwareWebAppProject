				...
				<form id="demo-form2" data-parsley-validate=""
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-6 col-xs-12">
							<input type="text" class="form-control" value="일정1">
						</div>
					</div>
					<div class="col-md-12">
						...
						<div class="form-group">
							&nbsp;&nbsp;당일:<input type="radio" class="flat" name="gender"
								id="genderM" value="M" checked="" required="">
							&nbsp;&nbsp;반복: <input type="radio" class="flat" name="gender"
								id="genderF" value="F">
						</div>
					</div>
									...
									<div class="controls">
										<div
											...
											<span class="add-on input-group-addon"><i
												...
												class="form-control"
												value="01/29/2018 09:00 AM - 01/29/2018 06:00 PM">
										</div>
									</div>
								</div>
							</fieldset>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<div id="editor-one" class="editor-wrapper placeholderText"
									contenteditable="true">내용입니다.</div>
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								&nbsp;&nbsp;하:<input type="radio" class="flat" name="gender"
									id="genderM" value="하" checked="" required="">
								&nbsp;&nbsp;중: <input type="radio" class="flat" name="gender"
									id="genderF" value="중"> &nbsp;&nbsp;상: <input
									type="radio" class="flat" name="gender" id="gender" value="상">
							</div>
						</div>
						...
						<div class="form-group form-inline">
							...
							<div class="input-group col-md-6 col-sm-6 col-xs-12">
								<input type="text" class="form-control" value="부장 영부장">
