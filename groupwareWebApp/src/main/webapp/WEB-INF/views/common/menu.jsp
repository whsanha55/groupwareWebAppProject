		...
		$.ajax({
			...
			success : function(data, textStatus, jqXHR){
				...
				for(var i=0; i<data.length; i++){
					htmlStr += "<li id="+data[i].boardNo+" class='boardList'><a href='<c:url value='/postList.do?boardNo="+data[i].boardNo+"&boardName="+data[i].boardName+"&empName=${requestScope.employee.empName}'/>'>" + data[i].boardName + "</a></li>" ; 
					}
