               ...
               <div class="col-sm-3">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                     ...
                     <td class=" ">5</td>
                     <td class=" ">각종 증명서</td>
                            <td><a data-toggle="modal" data-target="#myModal">업무문서 작성용 폰트.<a></td>
                     <td class=" ">영업부</td>
                            <td class=" ">일길동</td>
                   ...
                   <tr class="even pointer">   
                     <td class=" ">4</td>
                     <td class=" ">공문서</td>
                            <td><a data-toggle="modal" data-target="#myModal">외주시 계약서.<a></td>
                     <td class=" ">영업부</td>
                            <td class=" ">이길동</td>
                    ...
                    <tr class="even pointer">   
                     <td class=" ">3</td>
                     <td class=" ">거래문서</td>
                            <td><a data-toggle="modal" data-target="#myModal">회의록 문서입니다.<a></td>
                     <td class=" ">영업부</td>
                            <td class=" ">삼길동</td>
                 ...
                 <div class="text-center">
                  ...
                  <a class="btn btn-primary pull-right" href='<c:url value="addPost.do"/>'>글쓰기</a>
                  </div>
                 </div>
                    </div>
