      ...
      $.ajax({
         ...
         success: function (data, textStatus, jqXHR) {
            ...
            for(var i=0;i<data.roles.length;i++) {
               text += "<tr style='width:46px;' class='even pointer'><td class='a-center '><input type='checkbox' name='selected' id='ex_chk' value="+data.roles[i].rId+"></td>";
               text += "<td style='width:105px;' class='rId'>"+ data.roles[i].rId + "</td>";
               text += "<td style='width:238px;' class='rName'>"+ data.roles[i].rName + "</td>";
               text += "<td style='width:150px;' class='rType'>"+ data.roles[i].rType + "</td>";
               text += "<td style='width:200px;' class='rExplan'>"+ data.roles[i].rExplan + "</td>";
                      ...
                      <table id="datatable"  class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th style='width:105px;' class="column-title">롤 ID </th>
                            ...
                            <th style='width:200px;' class="column-title">등록일자</th>
